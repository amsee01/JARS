    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.Line>
{
    ...
    private com.amanladia.jars.model.Line readcom_akexorcist_googledirection_model_Line(android.os.Parcel parcel$$2) {
    ...
    private com.amanladia.jars.model.Agency readcom_akexorcist_googledirection_model_Agency(android.os.Parcel parcel$$3) {
    ...
    private com.amanladia.jars.model.Vehicle readcom_akexorcist_googledirection_model_Vehicle(android.os.Parcel parcel$$4) {
    ...
    private void writecom_akexorcist_googledirection_model_Line(com.amanladia.jars.model.Line line$$3, android.os.Parcel parcel$$5, int flags$$0) {
    ...
    private void writecom_akexorcist_googledirection_model_Agency(com.amanladia.jars.model.Agency agency$$3, android.os.Parcel parcel$$6, int flags$$1) {
        parcel$$6 .writeString(agency$$3 .name);
        parcel$$6 .writeString(agency$$3 .url);
    }

    private void writecom_akexorcist_googledirection_model_Vehicle(com.amanladia.jars.model.Vehicle vehicle$$2, android.os.Parcel parcel$$7, int flags$$2) {
