    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.Step>
{
    ...
    private com.amanladia.jars.model.Step readcom_akexorcist_googledirection_model_Step(android.os.Parcel parcel$$2) {
    ...
    private com.amanladia.jars.model.Info readcom_akexorcist_googledirection_model_Info(android.os.Parcel parcel$$3) {
    ...
    private com.amanladia.jars.model.Coordination readcom_akexorcist_googledirection_model_Coordination(android.os.Parcel parcel$$4) {
    ...
    private com.amanladia.jars.model.TransitDetail readcom_akexorcist_googledirection_model_TransitDetail(android.os.Parcel parcel$$5) {
    ...
    private com.amanladia.jars.model.StopPoint readcom_akexorcist_googledirection_model_StopPoint(android.os.Parcel parcel$$7) {
    ...
    private com.amanladia.jars.model.Line readcom_akexorcist_googledirection_model_Line(android.os.Parcel parcel$$8) {
    ...
    private com.amanladia.jars.model.Agency readcom_akexorcist_googledirection_model_Agency(android.os.Parcel parcel$$9) {
    ...
    private com.amanladia.jars.model.Vehicle readcom_akexorcist_googledirection_model_Vehicle(android.os.Parcel parcel$$10) {
    ...
    private com.amanladia.jars.model.RoutePolyline readcom_akexorcist_googledirection_model_RoutePolyline(android.os.Parcel parcel$$11) {
    ...
    private void writecom_akexorcist_googledirection_model_Step(com.amanladia.jars.model.Step step$$4, android.os.Parcel parcel$$12, int flags$$0) {
    ...
    private void writecom_akexorcist_googledirection_model_Info(com.amanladia.jars.model.Info info$$3, android.os.Parcel parcel$$13, int flags$$1) {
        parcel$$13 .writeString(info$$3 .text);
        parcel$$13 .writeString(info$$3 .value);
    }

    private void writecom_akexorcist_googledirection_model_Coordination(com.amanladia.jars.model.Coordination coordination$$4, android.os.Parcel parcel$$14, int flags$$2) {
        parcel$$14 .writeDouble(coordination$$4 .latitude);
        parcel$$14 .writeDouble(coordination$$4 .longitude);
    }

    private void writecom_akexorcist_googledirection_model_TransitDetail(com.amanladia.jars.model.TransitDetail transitDetail$$2, android.os.Parcel parcel$$15, int flags$$3) {
    ...
    private void writecom_akexorcist_googledirection_model_TimeInfo(com.amanladia.jars.model.TimeInfo timeInfo$$3, android.os.Parcel parcel$$16, int flags$$4) {
        parcel$$16 .writeString(timeInfo$$3 .timeZone);
        parcel$$16 .writeString(timeInfo$$3 .text);
        parcel$$16 .writeString(timeInfo$$3 .value);
    }

    private void writecom_akexorcist_googledirection_model_StopPoint(com.amanladia.jars.model.StopPoint stopPoint$$3, android.os.Parcel parcel$$17, int flags$$5) {
    ...
    private void writecom_akexorcist_googledirection_model_Line(com.amanladia.jars.model.Line line$$2, android.os.Parcel parcel$$18, int flags$$6) {
    ...
    private void writecom_akexorcist_googledirection_model_Agency(com.amanladia.jars.model.Agency agency$$3, android.os.Parcel parcel$$19, int flags$$7) {
        parcel$$19 .writeString(agency$$3 .name);
        parcel$$19 .writeString(agency$$3 .url);
    }

    private void writecom_akexorcist_googledirection_model_Vehicle(com.amanladia.jars.model.Vehicle vehicle$$2, android.os.Parcel parcel$$20, int flags$$8) {
        parcel$$20 .writeString(vehicle$$2 .name);
        parcel$$20 .writeString(vehicle$$2 .iconUrl);
        parcel$$20 .writeString(vehicle$$2 .type);
    }

    private void writecom_akexorcist_googledirection_model_RoutePolyline(com.amanladia.jars.model.RoutePolyline routePolyline$$2, android.os.Parcel parcel$$21, int flags$$9) {
