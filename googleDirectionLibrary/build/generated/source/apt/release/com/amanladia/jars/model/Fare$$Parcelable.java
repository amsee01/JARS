    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.Fare>
{
    ...
    public Fare$$Parcelable(android.os.Parcel parcel$$0) {
        ...
        if (parcel$$0 .readInt() == -1) {
            ...
            fare$$2 = readcom_amanladia_jars_model_Fare(parcel$$0);
        }
        fare$$0 = fare$$2;
    }
    ...
    public void writeToParcel(android.os.Parcel parcel$$1, int flags) {
        if (fare$$0 == null) {
            ...
            parcel$$1 .writeInt(1);
            writecom_amanladia_jars_model_Fare(fare$$0, parcel$$1, flags);
        }
    }

    private com.amanladia.jars.model.Fare readcom_amanladia_jars_model_Fare(android.os.Parcel parcel$$2) {
    ...
    private void writecom_amanladia_jars_model_Fare(com.amanladia.jars.model.Fare fare$$3, android.os.Parcel parcel$$3, int flags$$0) {
