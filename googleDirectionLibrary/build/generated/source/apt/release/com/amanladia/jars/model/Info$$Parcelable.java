    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.Info>
{
    ...
    public Info$$Parcelable(android.os.Parcel parcel$$0) {
        ...
        if (parcel$$0 .readInt() == -1) {
            ...
            info$$2 = readcom_amanladia_jars_model_Info(parcel$$0);
        }
        info$$0 = info$$2;
    }
    ...
    public void writeToParcel(android.os.Parcel parcel$$1, int flags) {
        if (info$$0 == null) {
            ...
            parcel$$1 .writeInt(1);
            writecom_amanladia_jars_model_Info(info$$0, parcel$$1, flags);
        }
    }

    private com.amanladia.jars.model.Info readcom_amanladia_jars_model_Info(android.os.Parcel parcel$$2) {
    ...
    private void writecom_amanladia_jars_model_Info(com.amanladia.jars.model.Info info$$3, android.os.Parcel parcel$$3, int flags$$0) {
