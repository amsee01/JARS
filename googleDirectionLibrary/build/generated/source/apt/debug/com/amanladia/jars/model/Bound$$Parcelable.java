    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.Bound>
{
    ...
    public Bound$$Parcelable(android.os.Parcel parcel$$0) {
        ...
        if (parcel$$0 .readInt() == -1) {
            ...
            bound$$2 = readcom_amanladia_jars_model_Bound(parcel$$0);
        }
        bound$$0 = bound$$2;
    }
    ...
    public void writeToParcel(android.os.Parcel parcel$$1, int flags) {
        if (bound$$0 == null) {
            ...
            parcel$$1 .writeInt(1);
            writecom_amanladia_jars_model_Bound(bound$$0, parcel$$1, flags);
        }
    }

    private com.amanladia.jars.model.Bound readcom_amanladia_jars_model_Bound(android.os.Parcel parcel$$2) {
        ...
        if (parcel$$2 .readInt() == -1) {
            ...
            coordination$$2 = readcom_amanladia_jars_model_Coordination(parcel$$2);
        }
    ...
    private void writecom_amanladia_jars_model_Bound(com.amanladia.jars.model.Bound bound$$3, android.os.Parcel parcel$$4, int flags$$0) {
        if (bound$$3 .southwest == null) {
            parcel$$4 .writeInt(-1);
        } else {
            parcel$$4 .writeInt(1);
            writecom_amanladia_jars_model_Coordination(bound$$3 .southwest, parcel$$4, flags$$0);
        }
        if (bound$$3 .northeast == null) {
            parcel$$4 .writeInt(-1);
        } else {
            parcel$$4 .writeInt(1);
            writecom_amanladia_jars_model_Coordination(bound$$3 .northeast, parcel$$4, flags$$0);
        }
    }

    private void writecom_amanladia_jars_model_Coordination(com.amanladia.jars.model.Coordination coordination$$3, android.os.Parcel parcel$$5, int flags$$1) {
