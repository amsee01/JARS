    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.Agency>
{
    ...
    public Agency$$Parcelable(android.os.Parcel parcel$$0) {
        ...
        if (parcel$$0 .readInt() == -1) {
            ...
            agency$$2 = readcom_amanladia_jars_model_Agency(parcel$$0);
        }
        agency$$0 = agency$$2;
    }
    ...
    public void writeToParcel(android.os.Parcel parcel$$1, int flags) {
        if (agency$$0 == null) {
            ...
            parcel$$1 .writeInt(1);
            writecom_amanladia_jars_model_Agency(agency$$0, parcel$$1, flags);
        }
    }

    private com.amanladia.jars.model.Agency readcom_amanladia_jars_model_Agency(android.os.Parcel parcel$$2) {
    ...
    private void writecom_amanladia_jars_model_Agency(com.amanladia.jars.model.Agency agency$$3, android.os.Parcel parcel$$3, int flags$$0) {
