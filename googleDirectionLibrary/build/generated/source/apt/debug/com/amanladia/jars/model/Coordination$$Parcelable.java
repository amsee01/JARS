    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.Coordination>
{
    ...
    public Coordination$$Parcelable(android.os.Parcel parcel$$0) {
        ...
        if (parcel$$0 .readInt() == -1) {
            ...
            coordination$$2 = readcom_amanladia_jars_model_Coordination(parcel$$0);
        }
    ...
    public void writeToParcel(android.os.Parcel parcel$$1, int flags) {
        if (coordination$$0 == null) {
            ...
            parcel$$1 .writeInt(1);
            writecom_amanladia_jars_model_Coordination(coordination$$0, parcel$$1, flags);
        }
    }

    private com.amanladia.jars.model.Coordination readcom_amanladia_jars_model_Coordination(android.os.Parcel parcel$$2) {
    ...
    private void writecom_amanladia_jars_model_Coordination(com.amanladia.jars.model.Coordination coordination$$3, android.os.Parcel parcel$$3, int flags$$0) {
