    ...
    implements Parcelable, ParcelWrapper<com.amanladia.jars.model.TimeInfo>
{
    ...
    public TimeInfo$$Parcelable(android.os.Parcel parcel$$0) {
        ...
        if (parcel$$0 .readInt() == -1) {
            ...
            timeInfo$$2 = readcom_amanladia_jars_model_TimeInfo(parcel$$0);
        }
    ...
    public void writeToParcel(android.os.Parcel parcel$$1, int flags) {
        if (timeInfo$$0 == null) {
            ...
            parcel$$1 .writeInt(1);
            writecom_amanladia_jars_model_TimeInfo(timeInfo$$0, parcel$$1, flags);
        }
    }

    private com.amanladia.jars.model.TimeInfo readcom_amanladia_jars_model_TimeInfo(android.os.Parcel parcel$$2) {
    ...
    private void writecom_amanladia_jars_model_TimeInfo(com.amanladia.jars.model.TimeInfo timeInfo$$3, android.os.Parcel parcel$$3, int flags$$0) {
